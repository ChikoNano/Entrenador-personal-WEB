...
La función requiere `SUPABASE_URL`, `SUPABASE_ANON_KEY`, `SUPABASE_SERVICE_ROLE_KEY` e `INVITE_REDIRECT_URL`. La `service_role` vive exclusivamente como secreto de la Edge Function.
